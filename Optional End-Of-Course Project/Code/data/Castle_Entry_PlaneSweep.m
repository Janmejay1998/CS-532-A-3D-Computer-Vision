...
i_ref = imread('data/castle-entry/0001.png');
i1 = imread('data/castle-entry/0000.png');
i2 = imread('data/castle-entry/0002.png');
...
imwrite(uint8((depth_map*16)),strcat('castle_entry_left_',num2str(znear),'to',num2str(zfar),'_',num2str(no_planes),'p_','ncc',num2str(win_size),'_depthmap.jpg'));
