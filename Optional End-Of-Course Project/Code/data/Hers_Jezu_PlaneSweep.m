...
i_ref = imread('data/hers-jezu/0006.png');
i1 = imread('data/hers-jezu/0005.png');
i2 = imread('data/hers-jezu/0007.png');
...
imwrite(uint8((depth_map*16)),strcat('hers_jezu_left_',num2str(znear),'to',num2str(zfar),'_',num2str(no_planes),'p_','ncc',num2str(win_size),'_depthmap.jpg'));
